...
export default function Page() {
  ...
  return (
    <div className="flex justify-center items-center w-full mt-[190px] mb-[100px] md:mt-0 md:mb-0 h-screen">
      <div className="flex flex-col md:flex-row items-center justify-center h-full w-full md:w-3/4 gap-7">

        <div className="flex flex-col align-center w-3/4 text-purple text-sm lg:text-base font-[family-name:var(--font-workSans)]"><p className="mb-1">Hi, I’m Jo.</p>
