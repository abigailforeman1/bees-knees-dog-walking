    ...
    <html lang="en">
      ...
      >
        <div className="flex flex-col">
          <header id={"header"} className={`w-screen flex items-center flex-col md:flex-row gap-4 md:gap-7 font-[family-name:var(--font-workSans)] mt-4 md:m-4`} style={{ zIndex: 100 }}>
